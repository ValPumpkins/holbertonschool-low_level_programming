...
/**
 * int is_prime_number(int n) - returns 1 if the input int is a prime number, otherwise return 0
 */

int is_prime_number(int n);

/**
 * int is_palindrome(char *s) - returns 1 if a string is a palindrome and 0 if not
 */
